-- FORCE UPDATE test images and clear ALL caches
-- Run this in TEST Supabase SQL editor (pbzpqsdjaiynrpjpubai)

-- 1. First, completely clear the KV store cache
TRUNCATE TABLE public.kv_store_a05c3297;

-- 2. Update ALL products with EXACT current production image URLs
...
-- 3. Show results
SELECT 'Cache cleared and all 16 products updated!' as status;
SELECT external_id, name,
  SUBSTRING(image_url FROM POSITION('product-images/' IN image_url) + 15) as image_file
